        ...
        <div class="portlet light bg-inverse">
            <div class="portlet-title">
                <div class="caption tight-bottom">                    
                    <span class="caption-subject font-blue bold" id="span_title">Form Data Wilayah</span>
                </div>
                ...
                <form action="#" class="form-horizontal" id="form_editing">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_nama_wilayah" id="txt_nama_wilayah" class="form-control input-small" placeholder="Nama Wilayah">                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_lat" id="txt_lat" class="form-control input-inline input-small numbers-only" placeholder="lat " />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Lng</label>
                            <div class="col-md-9">
                                <input type="text" name="txt_lng" id="txt_lng" class="form-control input-inline input-small numbers-only" placeholder="lng" />
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">Radius</label>
                            <div class="col-md-9">
                                <input type="text" name="txt_radius" id="txt_radius" class="form-control input-inline input-small numbers-only" placeholder="radius" />
                            </div>
                        </div>
                    </div>
