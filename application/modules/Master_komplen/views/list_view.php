...
<script src="<?=base_url();?>assets/app_js/master_komplen.js"></script>
                ...
                <form action="#" class="form-horizontal" id="form_editing">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_komplain" id="txt_komplain" class="form-control input-small" placeholder="ID Komplain">                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_judul" id="txt_judul" class="form-control input-inline input-medium" placeholder="Judul">                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_keterangan" id="txt_keterangan" class="form-control input-inline input-medium" placeholder="Keterangan">                                
                            </div>
                        </div>
