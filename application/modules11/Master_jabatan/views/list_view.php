                ...
                <form action="#" class="form-horizontal" id="form_editing">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_id" id="txt_id" class="form-control input-small" placeholder="ID Jabatan">                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_jabatan" id="txt_jabatan" class="form-control input-inline input-medium" placeholder="Jabatan">                                
                            </div>
                        </div>
