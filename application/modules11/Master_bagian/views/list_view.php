...
<script src="<?=base_url();?>assets/app_js/master_bagian.js"></script>
                ...
                <form action="#" class="form-horizontal" id="form_editing">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_id_agama" id="txt_id_agama" class="form-control input-small" placeholder="ID Bagian">                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_agama" id="txt_agama" class="form-control input-inline input-medium" placeholder="Bagian">                                
                            </div>
                        </div>
