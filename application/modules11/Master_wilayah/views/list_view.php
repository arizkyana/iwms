                ...
                <form action="#" class="form-horizontal" id="form_editing">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_nopol" id="txt_nopol" class="form-control input-small" placeholder="No.Polisi">                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_merek" id="txt_merek" class="form-control input-inline input-medium" placeholder="Merek">                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                            ...
                            <div class="col-md-9">
                                <div class="mt-radio-inline">
                                    <label class="mt-radio">
                                        <input type="radio" name="opt_jenis" id="opt_truck" value="truck" checked>Truck
                                        <span></span>
                                    </label>                                    
                                    <label class="mt-radio">
                                        <input type="radio" name="opt_jenis" id="opt_motor" value="motor">Motor
                                        <span></span>
                                    </label>                                    
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Tahun Produksi</label>
                            <div class="col-md-9">
                                <input type="text" name="txt_tahun" id="txt_tahun" class="form-control input-inline input-small numbers-only" placeholder="Tahun Produksi" />
                            </div>
                        </div>
                    </div>
