...
<script src="<?=base_url();?>assets/app_js/master_rumah.js"></script>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-home"></i>&nbsp;<span><?php echo $title;?></span>
                </div>
                <div class="tools">
                ...
                <form action="#" class="form-horizontal" id="form_editing">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_id_rumah" id="txt_id_rumah" class="form-control input-small" placeholder="ID Rumah">                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_wilayah" id="txt_wilayah" class="form-control input-inline input-medium" placeholder=" Wilayah">                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">
