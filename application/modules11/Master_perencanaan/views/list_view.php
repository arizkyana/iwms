...
<script src="<?=base_url();?>assets/app_js/master_perencanaan.js"></script>
                ...
                <form action="#" class="form-horizontal" id="form_editing">
                    <div class="form-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_id_perencanaan" id="txt_id_perencanaan" class="form-control input-small" placeholder="ID Perencanaan">                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_tgl_perencanaan" id="txt_tgl_perencanaan" class="form-control input-inline input-medium" placeholder="Tanggal Perencanaan">                                
                            </div>
                        </div>
                         <div class="form-group">
                            <label class="col-md-3 control-label">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_lokasi" id="txt_lokasi" class="form-control input-inline input-medium" placeholder="Lokasi">                                
                            </div>
                        </div>
                         <div class="form-group">
                            <label class="col-md-3 control-label">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_lavel" id="txt_lavel" class="form-control input-inline input-medium" placeholder="Level">                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_type" id="txt_type" class="form-control input-inline input-medium" placeholder="Type">                                
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-3 control-label">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="txt_keteranagan" id="txt_keteranagan" class="form-control input-inline input-medium" placeholder="Keteranagan">                                
                            </div>
                        </div>
