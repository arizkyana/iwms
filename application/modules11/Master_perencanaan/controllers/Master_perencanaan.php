...
class Master_perencanaan extends IO_Controller {

	function __construct(){

		parent::__construct();
		$this->load->model('Master_perencanaan_mod','model');
	}
	...
	function ajax_list(){
		...
		foreach ($list as $l) {
			...
			$act = '<a class="btn btn-primary btn-xs btn-flat" href="#" onclick="editData(\''.$l->id_ren.'\')"><i class="fa fa-edit"></i></a>&nbsp;';
			$act .= '<a class="btn btn-danger btn-xs btn-flat" href="#" onclick="deleteData(\''.$l->id_ren.'\')"><i class="fa fa-trash"></i></a>&nbsp;';
